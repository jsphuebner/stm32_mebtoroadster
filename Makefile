...
CFLAGS		= -Os -Wall -Wextra -Iinclude/ -Ilibopeninv/include -Ilibopencm3/include \
             -fno-common -fno-builtin -pedantic -DSTM32F1 -DMAX_ITEMS=154 -DMAX_MESSAGES=24 \
				 -mcpu=cortex-m3 -mthumb -std=gnu99 -ffunction-sections -fdata-sections
CPPFLAGS    = -Os -g3 -Wall -Wextra -Iinclude/ -Ilibopeninv/include -Ilibopencm3/include \
            -fno-common -std=c++11 -pedantic -DSTM32F1 -DMAX_ITEMS=154 -DMAX_MESSAGES=24 \
...
OBJSL		  = main.o hwinit.o mebbms.o roadsterbmb.o chademo.o stm32scheduler.o params.o terminal.o terminal_prj.o \
